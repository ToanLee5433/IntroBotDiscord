...
| :--- | :--- | :--- |
| **Phát nhạc Soundboard** | `@BotToan toan`<br>`@BotToan toàn`<br>`@BotToan giainghe`<br>`@BotToan xem stream`<br>`@BotToan bontre`<br>`@BotToan entry` | Phát soundboard trong phòng thoại (Voice) của người ra lệnh hoặc đối tượng được tag:<br>• **toan / toàn / giainghe:** Phát soundboard Toàn (Giải Nghệ) (`giainghe.mp3`).<br>• **xem stream:** Phát soundboard Thức Xem Stream (`ngudiemoi.mp3`).<br>• **bontre:** Phát soundboard Bọn Trẻ (`bontre.mp3`).<br>• **entry:** Phát soundboard Entry (`entry.mp3`). |
